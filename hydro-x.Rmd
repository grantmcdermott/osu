...
font_type <- 
  choose_font(
    c("Yanone Kaffeesatz", "CM Sans", "Lato")[1]
    )
...
- Dominant firms raise prices by withholding production. 
...
count: false
- **Research questions:**
  1. Does theory match up with the data? 
...
- Identify the *causal* impact of market power on firm behaviour.
- **Research questions:**
  1. Does theory match up with the data? (**Yes**)
...
```{r reservoirs, echo=FALSE, message=FALSE, warning=FALSE}
